...
Note that it is also possible to use the DMN engine independently from the Camunda Platform. Please refer to the [User Guide](/manual/latest/latest/user-guide/dmn-engine/embed/) and the [Example](https://github.com/camunda/camunda-bpm-examples/tree/master/dmn-engine/dmn-engine-java-main-method) for more details.
{{< /note >}}
