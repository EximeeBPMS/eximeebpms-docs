...
Note that it is also possible to use the DMN engine independently from the EximeeBPMS Platform. Please refer to the [User Guide](/manual/latest/user-guide/dmn-engine/embed/) and the [Example](https://github.com/EximeeBPMS/eximeebpms-examples/tree/master/examples/dmn-engine/dmn-engine-java-main-method) for more details.
{{< /note >}}
