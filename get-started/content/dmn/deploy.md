...
{{< get-code-eximeebpms repo="eximeebpms-get-started-dmn" tag="Step-4" >}}
...
* see how you can evaluate the decision using the [REST API](/rest/{{< minor-version >}}/#tag/Decision-Definition/operation/evaluateDecisionByKey),
