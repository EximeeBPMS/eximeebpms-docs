...
2. Add the EximeeBPMS & Spring Boot dependencies
...
## Add EximeeBPMS Platform & Spring Boot Dependencies
...
We add the Spring Boot BOM in the "dependency management" section and the EximeeBPMS Spring Boot Starter for Webapps, which will automatically include the EximeeBPMS engine and webapps in the app.
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd">
  ...
  <dependencies>
    <dependency>
      ...
      <version>${eximeebpms.spring-boot.version}</version>
    </dependency>
    <dependency>
...
The class is added in the `src/main/java` folder in the `org.eximeebpms.bpm.getstarted.loanapproval` package.

```java
package org.eximeebpms.bpm.getstarted.loanapproval;
...
Our first EximeeBPMS Spring Boot application is ready now. As a result of the build, you will have a JAR-file in your `target` folder. This JAR is a Spring Boot application,
which embeds inside Tomcat as a web container, EximeeBPMS engine and EximeeBPMS Web applications resources.
When started, it will use an in-memory H2 database for EximeeBPMS Engine needs.
...
```
Then go to [http://localhost:8080/](http://localhost:8080/) in your browser and enjoy the EximeeBPMS webapps.
