...
Releases 1.2.1-ep through 1.2.12-ee established the Enterprise Edition release pipeline. They contain no engine feature changes beyond what is present in [EximeeBPMS 1.3.0 CE]({{< ref "/release-notes/release-notes-1.3.0.md" >}}), which was released in parallel.
