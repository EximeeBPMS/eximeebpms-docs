...
No CVE-targeted fixes in this release. Several dependency vulnerabilities present at 1.0.0 were addressed in the [1.1.0 release]({{< ref "/release-notes/release-notes-1.1.0.md" >}}).
