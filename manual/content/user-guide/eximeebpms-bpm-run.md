...
In the unpacked distro, you will find a `resources` folder. All files (including BPMN, DMN, form, and script files) will be deployed when you start EximeeBPMS Run.
