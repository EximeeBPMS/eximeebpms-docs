...
<td>Allows creating this admin user even when an OAuth2/OIDC client registration or a read-only identity provider (e.g. LDAP) is also configured. Without it, startup fails fast instead — see the row below.</td>
<td><code>false</code></td>
</tr>
<tr>
<td colspan="4">
