...
String custom2 = start.getAttributeValueNs("http://camunda.org/custom", "custom-attribute-2");

// edit attributes by generic XML model API (with optional namespace)
start.setAttributeValue("custom-attribute", "new value");
start.setAttributeValueNs("http://camunda.org/custom", "custom-attribute", "new value");
```
