...
String custom2 = decisionTable.getAttributeValueNs("http://camunda.org/custom", "custom-attribute-2");
...
decisionTable.setAttributeValueNs("http://camunda.org/custom", "custom-attribute", "new value");
```
