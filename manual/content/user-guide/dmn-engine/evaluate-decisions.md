...
The DMN engine {{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnEngine.html" text="interface" >}} exposes methods
for parsing and evaluating DMN Decisions.

# Parse Decisions

Decisions can be parsed from an `InputStream` or transformed from a {{< javadocref page="org/eximeebpms/bpm/model/dmn/DmnModelInstance.html" text="DmnModelInstance" >}}.
...
It is possible to check if a parsed decision is implemented as [decision table] by using the method {{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnDecision.html#isDecisionTable()" text="isDecisionTable()" >}}.
...
To evaluate (or "execute") a decision, either pass an already transformed {{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnDecision.html" text="DmnDecision" >}} or use a DMN model instance or input stream in combination with a decision key.
...
The evaluation of a DMN decision returns a {{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnDecisionResult.html"
...
{{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnEngine.html##evaluateDecisionTable(org.eximeebpms.bpm.dmn.engine.DmnDecision, java.util.Map)"
text="evaluateDecisionTable()" >}} method if it is implemented as [decision table]. In this case, evaluation returns a {{< javadocref page="org/eximeebpms/bpm/dmn/engine/DmnDecisionTableResult.html" text="DmnDecisionTableResult" >}} which is semantically equal and provides the same methods as a
`DmnDecisionResult`.
