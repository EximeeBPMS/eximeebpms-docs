...
{{< note title="" class="warning" >}}
`UuidV1Generator` is deprecated since version 1.3.0 and will be removed in EximeeBPMS 1.4.0.
...
|---------|-------------------|--------------|
| ≤ 1.2.x | `StrongUuidGenerator` | UUID v1 (time-based, MAC address) |
| 1.3.0+  | `StrongUuidGenerator` | UUID v7 (time-ordered epoch) |
