...
The **EximeeBPMS External Task Client** allows you to set up remote service tasks for your workflow. There is a supported [Java](https://github.com/camunda/camunda-bpm-platform/tree/master/clients/java)
