...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>boolean</td>
    <td>
      <p>If true, the process application will be scanned for deployable resources (<code>.bpmn20.xml</code>, <code>.bpmn</code>, <code>.dmn11.xml</code> or <code>.dmn</code> files). Resources matching the <code>additionalResourceSuffixes</code> parameter are also included in the scan.</p>
      <p>
