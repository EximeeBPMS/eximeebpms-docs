...
EximeeBPMS Connect uses [eximeebpms-commons-logging](https://github.com/EximeeBPMS/eximeebpms/tree/main/commons/logging) which itself uses [SLF4J](http://slf4j.org) as
