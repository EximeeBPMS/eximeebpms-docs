...
A full example of this feature can be found in the [EximeeBPMS Examples Repository](https://github.com/EximeeBPMS/eximeebpms-examples/tree/master/examples/usertask/task-form-embedded-json-variables).
