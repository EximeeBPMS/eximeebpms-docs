...
A full example of this feature can be found in the [Camunda 7 Examples Repository](https://github.com/camunda/camunda-bpm-examples/tree/master/usertask/task-form-embedded-serialized-java-object).
