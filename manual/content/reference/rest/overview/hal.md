...
This caching can be configured in the `web.xml` file of the REST API (or the EximeeBPMS Web Application in
case the REST API is embedded into the EximeeBPMS Web Application).
    ...
    <param-value>
      {
        ...
        "caches": {
          ...
          "org.eximeebpms.bpm.engine.rest.hal.processDefinition.HalProcessDefinition": {
            "capacity": 100,
            "secondsToLive": 600
          }
        }
...
`org.eximeebpms.bpm.engine.rest.hal.cache.config`. The configuration is provided
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <code>org.eximeebpms.bpm.engine.rest.cache.Cache</code> interface.
      A simple default implementation is provided by the
      <code>org.eximeebpms.bpm.engine.rest.hal.cache.DefaultHalResourceCache</code> class.
    </td>
  </tr>
  <tr>
    <td>caches</td>
...
* Task: `org.eximeebpms.bpm.engine.rest.hal.task.HalTask`
* User: `org.eximeebpms.bpm.engine.rest.hal.user.HalUser`
