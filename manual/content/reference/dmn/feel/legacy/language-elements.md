...
The EximeeBPMS DMN engine supports FEEL for [input entries]. The FEEL term for
...
FEEL simple unary tests provide functions to create [date types]. The EximeeBPMS
