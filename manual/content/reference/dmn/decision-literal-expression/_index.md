...
Each decision should have an unique id when it is [deployed] to EximeeBPMS.
...
is used instead. The default expression language for literal expressions is FEEL.
