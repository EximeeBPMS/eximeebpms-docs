...
{{< img src="../../img/cockpit-plugin.jpg" title="Cockpit Plugin" >}}
...
{{< note title="Related Example" class="info">}}
  [How to develop a Cockpit plugin](https://github.com/EximeeBPMS/eximeebpms-examples/tree/master/examples/cockpit/cockpit-fullstack-count-processes)
{{< /note >}}
...
For more information on creating and configuring your own plugin, please see [How to develop a Cockpit plugin](https://github.com/EximeeBPMS/eximeebpms-examples/tree/master/examples/cockpit/cockpit-fullstack-count-processes).
...
{{< img src="../../img/plugin-points/plugin-point-navigation.jpg" title="Navigation" >}}
...
{{< img src="../../img/plugin-points/plugin-point-login-custom.jpg" title="Login" >}}
...
{{< img src="../../img/plugin-points/plugin-point-dashboard-custom.jpg" title="Dashboard" >}}
...
{{< img src="../../img/plugin-points/plugin-point-dashboard-metrics-view.jpg" title="Dashboard" >}}
...
{{< img src="../../img/plugin-points/plugin-point-cockpit-decisions-dashboard.jpg" title="Dashboard" >}}

## Cases Dashboard

**Name:** `cockpit.cases.dashboard`

{{< img src="../../img/plugin-points/plugin-point-cockpit-cases-dashboard.jpg" title="Dashboard" >}}

## Process Definition Runtime Tab

**Name:** `cockpit.processDefinition.runtime.tab`

{{< img src="../../img/plugin-points/plugin-point-process-definition-details.jpg" title="Process Definition Runtime Tab" >}}
...
{{< img src="../../img/plugin-points/plugin-point-process-definition-runtime-action.jpg" title="Process Definition Runtime Action" >}}
...
{{< img src="../../img/plugin-points/plugin-point-cockpit-process-definition-view.jpg" title="Process Definition View" >}}

## Process Instance View

**Name:** `cockpit.processInstance.view`

{{< img src="../../img/plugin-points/plugin-point-cockpit-process-instance-view.jpg" title="Process Instance View" >}}

## Process Definition Diagram Overlay

**Name:** `cockpit.processDefinition.diagram.plugin`

{{< img src="../../img/plugin-points/plugin-point-definition-diagram-overlay.jpg" title="Definition Diagram Overlay" >}}
...
{{< img src="../../img/plugin-points/plugin-point-instance-diagram-overlay.jpg" title="Instance Diagram Overlay" >}}
...
{{< img src="../../img/plugin-points/plugin-point-job-definition-action.jpg" title="Job Definition Action" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-definition-tab.jpg" title="Decision Definition Tab" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-definition-action.jpg" title="Decision Definition Action" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-definition-table.jpg" title="Decision Definition Table" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-instance-tab.jpg" title="Decision Instance Tab" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-instance-action.jpg" title="Decision Instance Action" >}}
...
{{< img src="../../img/plugin-points/plugin-point-decision-instance-table.jpg" title="Decision Instance Table" >}}
...
{{< img src="../../img/plugin-points/plugin-point-repository-resource-action.jpg" title="Repository Resource Action" >}}
...
{{< img src="../../img/plugin-points/plugin-point-repository-resource-detail.jpg" title="Repository Resource Detail" >}}
...
{{< img src="../../img/plugin-points/plugin-point-task-dashboard.jpg" title="Open Task Dashboard" >}}
...
{{< img src="../../img/plugin-points/plugin-point-incident-action.jpg" title="Incident Action" >}}
