...
A Send Task is used to send a message. In EximeeBPMS this is done by calling Java code.
...
```xml
<sendTask id="sendTask" camunda:class="org.eximeebpms.bpm.MySendTaskDelegate" />
```
