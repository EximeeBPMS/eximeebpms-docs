...
Check for [available database patch scripts]({{< ref "//#database-patches" >}}) for an overview of available sql patch scripts  to see if there are any for your current version.
