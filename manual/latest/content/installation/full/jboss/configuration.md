...
<subsystem xmlns="urn:org.eximeebpms.bpm.jboss:1.1">
  <process-engines>
    <process-engine name="default" default="true"> ...
      ...
      <plugins>
        <plugin>
          <class>org.eximeebpms.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin</class>
          <properties>

            <property name="serverUrl">ldap://localhost:4334/</property>
            <property name="managerDn">uid=jonny,ou=office-berlin,o=eximeebpms,c=org</property>
            <property name="managerPassword">s3cr3t</property>

            <property name="baseDn">o=eximeebpms,c=org</property>
...
Users and Groups in the EximeeBPMS web application. In order to activate this, add the following
configuration to the `web.xml` file of the EximeeBPMS web application
(`eximeebpms-webapp-wildfly-$PLATFORM_VERSION.war/WEB-INF/lib` or `eximeebpms-webapp-jboss-$PLATFORM_VERSION.war/WEB-INF/lib`):
...
<web-app version="2.5" xmlns="http://java.sun.com/xml/ns/javaee"
  ...
  <listener>
    <listener-class>org.eximeebpms.bpm.engine.rest.hal.cache.HalRelationCacheBootstrap</listener-class>
  </listener>

  <context-param>
    <param-name>org.eximeebpms.bpm.engine.rest.hal.cache.config</param-name>
    <param-value>
      {
        "cacheImplementation": "org.eximeebpms.bpm.engine.rest.hal.cache.DefaultHalResourceCache",
        "caches": {
          "org.eximeebpms.bpm.engine.rest.hal.user.HalUser": {
            "capacity": 100,
            "secondsToLive": 900
          },
          "org.eximeebpms.bpm.engine.rest.hal.group.HalGroup": {
            "capacity": 100,
            "secondsToLive": 900
          }
        }
...
2.  Add the module dependency to the file `$WILDFLY_HOME/modules/org/eximeebpms/bpm/eximeebpms-engine-plugins/main/module.xml` and set the attribute `export="true"` to make sure that the module is visible in the classpath of EximeeBPMS's subsystem
      ```xml
    <module xmlns="urn:jboss:module:1.0"
            name="org.eximeebpms.bpm.eximeebpms-engine-plugins">
      <dependencies>
        <!-- ... -->
        <module name="org.eximeebpms.bpm.eximeebpms-custom-engine-plugin" export="true" />
      </dependencies>
    </module>
      ```
      
    The `module.xml` file is included in the EximeeBPMS distribution. If you install EximeeBPMS on a vanilla WildFly container, this file needs to be created manually.
...
<filter>
  ...
  <filter-class>
    org.eximeebpms.bpm.webapp.impl.security.filter.headersec.HttpHeaderSecurityFilter
  </filter-class>
</filter>
