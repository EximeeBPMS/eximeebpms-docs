...
If you are only interested in operations concerning Authorizations, you can use the `Entity Type` filter. For a complete list of logged operations, check out [History and Audit Event Log](/manual/process-engine/history/#glossary-of-operations-logged-in-the-user-operation-log).
