...
{{< img src="../img/admin-users.jpg" title="User Menu" >}}
...
If you installed the default EximeeBPMS webapps and demo content, EximeeBPMS was configured with several demo users. The default admin user can be accessed with the following credentials:
