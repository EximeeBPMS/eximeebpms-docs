...
menu:
  main:
    ...
    pre: "A HTTP Header Security Filter for the EximeeBPMS Web Applications"
---
...
It is a common practice to extend EximeeBPMS web applications by custom scripts and forms.
