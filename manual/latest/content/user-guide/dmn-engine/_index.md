...
The EximeeBPMS DMN engine is a Java library which can evaluate DMN decision tables.
...
application or in combination with EximeeBPMS. This section
covers how to embed the library and use it to evaluate decisions. For more
information on the integration in EximeeBPMS, please see the
